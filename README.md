...
This is a simplified project demonstrating how Claude Code can accelerate
BIM data dictionary development and quality assurance automation.

## Project Background

This project builds a **data dictionary** for underground utility assets —
pipes, conduits, manholes, and related infrastructure. A data dictionary
defines every object type, property, and rule needed to represent these
assets consistently in BIM models and databases.
...
**Underground Utilities (UGU)** — the primary domain for this demo.
Asset types include: Pipe, Conduit, Manhole, Valve.
